...
<header>
  ...
  <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
    <div class="container">
      <a class="navbar-brand" style="font-weight: bold; font-size:28px;" href="#">No waste</a>
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        <ul class="navbar-nav me-auto mb-2 mb-md-0 mx-auto" style="font-weight: bold;">
          <li class="nav-item">
            <a class="nav-link <?php echo !empty($information)?"active":"" ?>" href="accueilUser.php">Informations</a>
          </li>
          <li class="nav-item">
            <a class="nav-link <?php echo !empty($messagerie)?"active":"" ?>" href="messagerieChauffeur.php">Messagerie <i class="fa-solid fa-message" style="color: #ec3c3c;"></i></a>
          </li>
          <!-- <li class="nav-item">
