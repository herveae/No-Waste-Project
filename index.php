...
<div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
  <header class="mb-auto">
    <div>
      <h3 class="float-md-start mb-3">No waste</h3>
      <nav class="nav nav-masthead justify-content-center float-md-end">
        <a class="nav-link fw-bold py-1 px-0 active" aria-current="page" href="#">Home</a>
        <a class="nav-link fw-bold py-1 px-0" href="interfaceConnexion.php">Connexion</a>
        <!-- <a class="nav-link fw-bold py-1 px-0" href="#">Contact</a> -->
      </nav>
    </div>
  </header>

  <main class="px-3"  data-aos="fade-up">
    <h1>No waste</h1>
    <p class="lead">Lorem, ipsum dicta aliquid perspiciatis provident deleniti nihil aspernatur nobis nulla ipsa ipsam quibusdam reiciendis voluptas impedit, facilis a vitae eum explicabo consectetur.</p>
    <p class="lead">
      <a href="interfaceConnexion.php" class="btn btn-lg btn-light fw-bold border-white bg-white">Zone de travail</a>
    </p>
  </main>
